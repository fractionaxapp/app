...
export function UnderwritingExtract() {
	return (
		<section className="fx-section fx-bleed">
			<SectionBar
				label="What it reads"
				copy="The same clause, before and after. Seven fields out of one paragraph, including two that disagree with each other."
			/>
					...
					<div className="grid gap-px bg-border lg:grid-cols-2">
						<div className="bg-surface px-5 py-6">
							...
							<p className="mt-4 font-mono text-sm leading-relaxed text-muted">
								...
								<Mark n={1}>nine and two-tenths percent (9.2%)</Mark> per annum,
								payable <Mark n={2}>quarterly in arrears</Mark> commencing on
								the first Payment Date following the Closing Date. The Issuer
								shall at all times maintain a Debt Service Coverage Ratio of{" "}
								<Mark n={3}>not less than 1.50 to 1.00</Mark>, such ratio to be
								tested{" "}
								<Mark n={4}>as of the last day of each fiscal quarter</Mark> and
								certified to the Trustee together with the{" "}
								<Mark n={5}>semi-annual financial statements</Mark> required
								under Section 7.2. The Notes shall mature{" "}
								<Mark n={6}>twenty-four (24) months</Mark> from the Closing Date
								and shall rank as <Mark n={7}>senior secured obligations</Mark>
								{" of the Issuer …"}
							</p>
						</div>
