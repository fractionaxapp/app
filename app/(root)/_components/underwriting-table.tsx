	...
	return (
		<section className="fx-section fx-bleed bg-surface">
			<div className="grid gap-x-8 gap-y-10 lg:grid-cols-[1fr_2fr_1fr]">
				<div>
					<p className="fx-eyebrow text-muted">What comes out</p>
					<p className="mt-4 max-w-70 text-pretty text-muted">
						Three issuers, three document formats, one grid. Sorting by yield is
						only meaningful once every row means the same thing.
					</p>
				</div>

				{/*
				 * min-w-0 is load-bearing. A grid item defaults to min-width:auto,
				 * so without it the item refuses to shrink below the table's
				 * min-width, overflow-x-auto never engages, and the whole page
				 * scrolls sideways on a phone instead of just the table.
				 */}
