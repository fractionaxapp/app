...
export function DiscoveryFunnel() {
	return (
		<section className="fx-section fx-bleed">
			<SectionBar
				label="What the mandate cuts"
				copy="One sentence, applied clause by clause. The asset class does most of the work; the yield floor barely halves what is left."
			/>
				...
				<div className="border border-border bg-surface">
					<div className="border-b border-border px-5 py-5">
						...
						<p className="mt-3 font-mono text-sm leading-relaxed text-pretty sm:text-base">
							<span className="text-accent">&gt;</span> Private credit yielding
							8%+, minimum under $25K, Asia exposure, moderate risk.
						</p>
					</div>
					...
					<p className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1 border-t border-border bg-surface-muted px-5 py-4">
						<span className="fx-eyebrow text-muted">Survived every clause</span>
