...
export function UnderwritingParity() {
	return (
		<section className="fx-section fx-bleed">
			<SectionBar
				label="The same work, either way"
				copy="A $25K allocation takes the same human work as a $25M one. That is why nobody does the small ones — and why we can."
			/>

			<div className="mt-10 min-w-0">
				<div className="border border-border bg-surface">
					<div className="grid grid-cols-[1.2fr_1fr_1fr] border-b border-border">
						<p className="fx-eyebrow px-5 py-3.5 text-muted">Underwriting a</p>
				...
				<p className="mt-5 text-sm text-pretty text-muted">
					...
					all, because three weeks of analyst time cannot be justified against a
					$25,000 cheque. That is the whole gap this closes.
				</p>
			</div>
		</section>
	);
